...
// path invoked is '/vmorc/offers/v1/bycontentid';
offers_data_api.retrieveOffersByContentId(getParameters())
    .then(function(result) {
        ...
        console.log('\n--------------- API is Offers Data Api ---------------');
        console.log('\n--------------- EndPoint is retrieveOffersByContentId ---------------');
        console.log('\n\n');
    })
...
function getParameters() {
    var parameters = {
        ...
        "contentid": "{enter appropriate value}",
