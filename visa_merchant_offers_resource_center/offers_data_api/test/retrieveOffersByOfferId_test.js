...
// path invoked is '/vmorc/offers/v1/byofferid';
offers_data_api.retrieveOffersByOfferId(getParameters())
    .then(function(result) {
        ...
        console.log('\n--------------- EndPoint is retrieveOffersByOfferId ---------------');
        console.log('\n\n');
    })
...
function getParameters() {
    var parameters = {
        ...
        "offerid": "{enter appropriate value}",
